...
project = 'PyImfit'
copyright = '2019-2022, Peter Erwin'
author = 'Peter Erwin'
...
latex_documents = [
    (master_doc, 'Pyimfit.tex', 'Pyimfit Documentation',
     'Peter Erwin', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyimfit', 'Pyimfit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Pyimfit', 'Pyimfit Documentation',
     author, 'Pyimfit', 'One line description of project.',
     'Miscellaneous'),
]
